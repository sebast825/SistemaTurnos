...
public class GenerarHorariosDisponiblesPorMesTest
{
    ...
    public void Setup()
    {
            ...
            List<TimeSpan> horariosEsperados = new List<TimeSpan>()
        {
            ...
            List<TurnoHorarioDisponibleResponseDTO> rst = _generadorHorariosDisponibles.GenerarHorariosDisponiblesPorMes(medicoId, turnosList, disponibilidadMedicosList);
